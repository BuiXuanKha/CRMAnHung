...
6. **Ảnh:** `alt` mô tả (lô = tên + địa chỉ); sitemap có `images` (CDN, không `/og-default.png`); JSON-LD `ImageObject` — [`PUBLIC-SEO.md`](../../../docs/PUBLIC-SEO.md) §10. Gallery SSR đủ URL. Không chặn Googlebot trên CDN.
