...
6. **Ảnh:** lúc **tạo/upload lô** server đặt CDN key `{slug-ten-dia-chi}-anh-n` (không tin `IMG_1234`). Trang khách: `alt` mô tả; sitemap `images`; JSON-LD `ImageObject` — [`PUBLIC-SEO.md`](../../../docs/PUBLIC-SEO.md) §10. Gallery SSR đủ URL. Không chặn Googlebot trên CDN.
