...
|-----------|--------|---------|
| Ảnh công khai / CRM không mật | `upload()` | Raster → **WebP** (`sharp`, cạnh dài ≤ 2560) rồi CDN. Gồm ảnh chat **mới** từ `POST /customers/from-extension`. JPEG/PNG cũ: `pnpm images:webp-replace` |
