...
| 9 | Tin nhắn + ảnh chat `imgsmessenger` → R2 public | `customer_messenger`, `customer_messenger_image` | `pnpm chat:migrate-legacy` | Code sẵn; chưa copy staging (~418 MB, 20253 tin / 2448 ảnh) |
