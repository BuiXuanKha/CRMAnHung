...
3. Ảnh OG = ảnh bìa; thiếu → `/og-default.png`. Ảnh SEO: upload lô đặt CDN key `{slug}-anh-n`; `alt` tên+địa chỉ; sitemap `image:loc`; JSON-LD `ImageObject` — [`PUBLIC-SEO.md`](../PUBLIC-SEO.md) §10.
