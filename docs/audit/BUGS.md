...
| FIXED / CLOSED | 69 |
| Lần audit gần nhất | 2026-09-08 — Owner đóng hẳn BUG-041 (won't fix); không sửa code |
...
**Đếm sau đóng BUG-041 (2026-09-08, theo Status detail + header):** OPEN **14** · FIXED / CLOSED **69** · tổng **83**.
